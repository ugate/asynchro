...
lab.experiment(plan, () => {
  ...
  lab.test(`${plan}: extracted/named, object, no-error`, { timeout: TEST_TKO }, async (flags) => {
    const a = 2, b = 4, c = 6;
    const promisifier = Asynchro.asyncCallback(myCallbackObj, 'multiply', callback);
  ...
  lab.test(`${plan}: named, object, no-error`, { timeout: TEST_TKO }, async (flags) => {
    const a = 2, b = 4, c = 6;
    const promisifier = Asynchro.asyncCallback(myCallbackObj, 'multiply', [ 'a', 'b', 'c' ]);
    const rslt = await promisifier(a, b, c);
  ...
  lab.test(`${plan}: named, class, no-error`, { timeout: TEST_TKO }, async (flags) => {
    const a = 8, b = 10, c = 12;
    const promisifier = Asynchro.asyncCallback(myCallbackClass, 'multiply', [ 'a', 'b', 'c' ]);
    const rslt = await promisifier(a, b, c);
  ...
  lab.test(`${plan}: un-named, object, no-error`, { timeout: TEST_TKO }, async (flags) => {
    const a = 2, b = 4, c = 6;
    const promisifier = Asynchro.asyncCallback(myCallbackObj, 'multiply');
    const rslt = await promisifier(a, b, c);
  ...
  lab.test(`${plan}: un-named, class, no-error`, { timeout: TEST_TKO }, async (flags) => {
    const a = 8, b = 10, c = 12;
    const promisifier = Asynchro.asyncCallback(myCallbackClass, 'multiply');
    const rslt = await promisifier(a, b, c);
